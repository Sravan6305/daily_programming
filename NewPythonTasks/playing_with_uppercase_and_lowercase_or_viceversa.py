...
# register in every word so that it either only consisted of lowercase letters or,
...
# If a word contains an equal number of uppercase and lowercase letters, you should replace all the letters with
# lowercase ones. For example, maTRIx should be replaced by matrix.
...
if len(word.upper()) == len(word.lower()):
    print(word.lower())
elif len(word.upper()) != len(word.lower()):
    print(word.upper())
