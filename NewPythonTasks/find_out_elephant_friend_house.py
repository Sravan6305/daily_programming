...
# It turned out that the elephant's house is located at point 0 and his friend's house is located at
# point x(x>0) of the coordinate line.
...
home = int(input("enter the distance: "))
